...
unsigned int *cmem2_in_buffer = (unsigned int*)(mb2_cmemout0_BASEADDR);
unsigned int *cmem2_out_buffer = (unsigned int*)(mb2_cmemout0_BASEADDR + (mb2_cmemout0_SIZE >> 1) );
