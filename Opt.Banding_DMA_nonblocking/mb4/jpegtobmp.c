...
unsigned int *cmem4_in_buffer0 = (unsigned int*)(mb4_cmemout0_BASEADDR);
unsigned int *cmem4_out_buffer0 = (unsigned int*)(mb4_cmemout1_BASEADDR);
// unsigned int *cmem4_out_buffer0 = (unsigned int*)(mb4_cmemout0_BASEADDR + (mb4_cmemout0_SIZE >> 1) );
// unsigned int *cmem4_in_buffer1 = (unsigned int*)(mb4_cmemout1_BASEADDR);
// unsigned int *cmem4_out_buffer1 = (unsigned int*)(mb4_cmemout1_BASEADDR + (mb4_cmemout1_SIZE >> 1) );
