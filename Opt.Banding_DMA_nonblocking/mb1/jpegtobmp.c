...
unsigned int *cmem_in_buffer = (unsigned int*)(mb1_cmemout0_BASEADDR);
//volatile fifo_t* DMAcore1 = (fifo_t*) (mb1_cmemout0_BASEADDR );
...
{
	int a;
	for( a = 0; a < 3145728; a+=4)
	{
		FrameBuffer[a] = 0xFF;
		FrameBuffer[(a+1)] = 0x00;
		FrameBuffer[(a+2)] = 0x00;
		FrameBuffer[(a+3)] = 0x00;
	}
}
/*
