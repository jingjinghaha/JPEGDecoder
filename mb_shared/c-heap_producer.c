                        ...
                        unsigned int token_size)
{
	if(producer_adm->dma_address > 0 && write_pointer >= REMOTE_BASE_ADDRESS) {
		...
		DMA_usage((void *)write_pointer, (void *)d, token_size/4,(void *)producer_adm->dma_address);
		...
		if(write_pointer >= REMOTE_SHARED_ADDRESS) {
			DMA_usage((void *)d, (void *)write_pointer, token_size/4, (void *)producer_adm->dma_address);
