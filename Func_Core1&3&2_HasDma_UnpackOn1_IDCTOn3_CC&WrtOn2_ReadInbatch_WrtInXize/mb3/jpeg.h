...
/*Define fifo_size for communication*/
 #define FIFO_SIZE1_3  15
 #define FIFO_SIZE3_2  10
...
// struct TOKEN_TO_IDCT{
	// volatile FBlock FBuff;
	// volatile int flag;
	// // volatile int curcomp;
// };
...
extern volatile fifo_t* producer13 ;
extern volatile fifo_t* consumer13 ;
extern volatile fifo_t* producer32 ;
extern volatile fifo_t* consumer32 ;
extern volatile int* producer_data32;
extern volatile int* consumer_data32;
extern volatile int* fifo_sync13;
extern volatile int* fifo_sync32;
