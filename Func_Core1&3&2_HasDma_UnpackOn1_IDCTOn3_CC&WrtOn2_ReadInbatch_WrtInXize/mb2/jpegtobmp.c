...
volatile fifo_t* producer32 = (fifo_t*) (mb3_cmemin0_pt_REMOTEADDR + 1 * sizeof(fifo_t) + FIFO_SIZE1_3 * sizeof(FBlock) + 4);
volatile fifo_t* consumer32 = (fifo_t*) mb2_cmemin0_BASEADDR;
volatile int* fifo_sync32 = (int*) (mb2_cmemin0_BASEADDR + 1 * sizeof(fifo_t) + FIFO_SIZE3_2 * sizeof(PBlock));
...
int JpegToBmp()
{
	...
	do {
		...
		case SOF_MK:  //ffc0 start of the frame
			...
			ColorBuffer = (unsigned int *)mk_malloc((size_t) x_size * MCU_sy * sizeof(int));
