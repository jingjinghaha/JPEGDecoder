...
volatile fifo_t* producer13 = (fifo_t*) mb1_cmemin0_BASEADDR;
volatile fifo_t* consumer13 = (fifo_t*) mb3_cmemin0_pt_REMOTEADDR;
volatile int* producer_data13 = (int*) (mb3_cmemin0_pt_REMOTEADDR + 1 * sizeof(fifo_t));
volatile int* consumer_data13 = (int*) (mb3_cmemin0_BASEADDR + 1 * sizeof(fifo_t));
...
volatile int* fifo_sync13 = (int*) (mb3_cmemin0_pt_REMOTEADDR + 1 * sizeof(fifo_t) + FIFO_SIZE1_3 * sizeof(FBlock));
...
int main (void)
{
	...
	cheap_init_fifo(
			...
			FIFO_SIZE1_3,  // fifo size
			(unsigned int)producer_data13,
			(unsigned int)consumer_data13,
#ifdef USE_DMA
			mb1_dma0_BASEADDR,
			mb1_cmemout0_BASEADDR+sizeof(int),
			mb3_dma0_BASEADDR,
			mb3_cmemout0_BASEADDR);
#else
			0,
			0,
			0,
...
#endif
#ifdef USE_DMA
	unsigned int *f = (unsigned int *)mb1_cmemout0_BASEADDR;	
	*f =1 ;
	hw_dma_send_addr((void*)fifo_sync13, (void*)f, 1, (void*)mb1_dma0_BASEADDR);
