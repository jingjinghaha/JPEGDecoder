...
volatile fifo_t* producer32 = (fifo_t*) mb3_cmemin0_BASEADDR;
...
volatile int* fifo_sync32 = (int*) (mb2_cmemin0_pt_REMOTEADDR + 1 * sizeof(fifo_t) + FIFO_SIZE3_2 * sizeof(FBlock));
	...
	for (;i<3;i++)
{
  ...
  // while (i<=5)
  // {
	// int mark = get_next_MK();
	// mk_mon_debug_info(55555555);
	...
	//TIME diff_time = t2 - t1;
	//mk_mon_debug_info(232323);
	//mk_mon_debug_info(LO_64(diff_time));
	//mk_mon_debug_info(232323);
