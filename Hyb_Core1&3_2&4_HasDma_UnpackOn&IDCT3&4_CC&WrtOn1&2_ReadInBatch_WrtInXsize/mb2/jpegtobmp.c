...
volatile fifo_t* producer42 = (fifo_t*) mb4_cmemin0_pt_REMOTEADDR;
volatile fifo_t* consumer42 = (fifo_t*) mb2_cmemin0_BASEADDR;
volatile int* fifo_sync42 = (int*) (mb2_cmemin0_BASEADDR + 1 * sizeof(fifo_t) + FIFO_SIZE4_2 * sizeof(PBlock));
...
unsigned int *cmem_out_buffer = (unsigned int*)(mb2_cmemout0_BASEADDR + (mb2_cmemout0_SIZE >> 1) );
...
int main (void)
{
   ...
   mk_mon_debug_info(0xFF444D41);//end of DMA_counters	mk_mon_debug_tile_finished();
