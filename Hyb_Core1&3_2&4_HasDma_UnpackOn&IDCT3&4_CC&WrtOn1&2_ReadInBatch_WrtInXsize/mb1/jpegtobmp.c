...
volatile fifo_t* producer31 = (fifo_t*) (mb3_cmemin0_pt_REMOTEADDR);
volatile fifo_t* consumer31 = (fifo_t*) mb1_cmemin0_BASEADDR;
volatile int* fifo_sync31 = (int*) (mb1_cmemin0_BASEADDR + 1 * sizeof(fifo_t) + FIFO_SIZE3_1 * sizeof(PBlock));
