...
{	
	...
	unsigned int *d = (unsigned int *)(mb1_cmemout0_BASEADDR+(mb1_cmemout0_SIZE>>1));
	if (n_comp > 1)
	for (i = 0; i < goodrows; i++)
	{
		...
		DMA_usage((void *)(bmp_buffer + offset + (i << 12)), (void *)d, goodcolumns,(void *)mb1_dma0_BASEADDR);
		hw_dma_send_addr((void *)(bmp_buffer + offset + (i << 12)), (void *)d, goodcolumns,(void *)mb1_dma0_BASEADDR);
	}
