...
{	
	...
	unsigned int *d = (unsigned int *)(mb3_cmemout1_BASEADDR);
	if (n_comp > 1)
	for (i = 0; i < goodrows; i++)
	{
		...
		DMA_usage((void *)(bmp_buffer + offset +   (i << 12)), (void *)d, goodcolumns,(void *)mb3_dma1_BASEADDR);
		hw_dma_send_addr((void *)(bmp_buffer + offset +   (i << 12)), (void *)d, goodcolumns,(void *)mb3_dma1_BASEADDR);
	}
